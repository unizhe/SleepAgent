# 本模块实施 Agent 工作产品验收、安全审查与发布治理规则。
...
from sleepagent.runtime.registry import authorize_tool_invocation
        ...
        *,
        ...
        with self.lock:
            ...
            governed = GovernedMemoryItemV2(
                ...
                provenance_type=ProvenanceType(candidate.provenance_type),
                ...
                allowed_purposes=tuple(
                    MemoryPurpose(value) for value in candidate.allowed_purposes
                ),
                status=status,
                supersedes_ref=(
    ...
    def _transition_care_state(
        ...
        *,
        ...
        with self.care_store.lock:
            ...
            transition = CareTransitionEvent.model_validate(
                {
