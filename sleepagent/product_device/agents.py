...
class RadarProductAgent:
    """Build v1 product dashboard state from radar device data."""
    ...
    def run(
        ...
        *,
        ...
        return self.build_dashboard_summary(
            device=device,
...
DeviceCareAgent = RadarProductAgent
...
def _build_recommended_actions(data_quality) -> list[str]:
