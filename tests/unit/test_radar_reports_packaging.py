...
import sleepagent.product_runtime.reports as public_reports
import sleepagent.product_runtime.reports.rendering as report_rendering
import sleepagent.product_runtime.reports.roles as report_roles
...
def test_only_root_report_artifacts_are_git_ignored() -> None:
    ...
    assert not _is_git_ignored("sleepagent/product_runtime/reports/__init__.py")
    assert not _is_git_ignored("sleepagent/product_runtime/reports/rendering.py")
    assert not _is_git_ignored("sleepagent/product_runtime/reports/roles.py")
...
def test_reports_package_is_discoverable_for_distribution() -> None:
    ...
    assert "sleepagent.product_runtime.reports" in packages
    assert (ROOT / "sleepagent/product_runtime/reports/rendering.py").is_file()
