...
from sleepagent.product_runtime.runner import (
...
def _product_episode_runner() -> ProductEpisodeRunnerPort:
    return _PRODUCT_EPISODE_RUNNER or _PRODUCT_RUNTIME_BUNDLE.runner


def _product_agent_is_configured(runner: ProductEpisodeRunnerPort) -> bool:
