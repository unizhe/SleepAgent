...
- All 28 implementation acceptance criteria are mapped in
  `sleep_habit_profile/ACCEPTANCE-MATRIX.md`.
...
- Release remains intentionally fail-closed: no real 3–5-participant
  ...
  in `sleep_habit_profile/USABILITY-TEST-PROTOCOL.md`, and the checked-in
...
`sleep_habit_profile/real-evidence-v18-collection` with:
...
`sleep_habit_profile/simulated-evidence-v18-complete`; its ZIP archive is
...
`sleep_habit_profile/ONLINE-REASONING-FREEZE.md`; PLAN, concept coverage,
