...
1. [`../agent_architecture/PLAN.md`](../agent_architecture/PLAN.md) 继续决定 Agent
   名单、责任、Episode、Memory/State、权限、Safety、Tool 和 Commit 边界。
2. [`../skills_design/PLAN.md`](../skills_design/PLAN.md) 继续决定 Skill、
   Registry、Resolver、Compiler、SkillLock、Outcome 和离线演进治理。
3. [`../sleep_habit_profile/PLAN.md`](../sleep_habit_profile/PLAN.md) 继续决定
