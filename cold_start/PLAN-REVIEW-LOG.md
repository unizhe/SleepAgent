...
- Added the single stateless policy owner
  `sleepagent/radar_agent/product_agent/cold_start.py` with the finite claim
...
- `agent_architecture/ACCEPTANCE-MANIFEST.json`
- `backend/main.py`
- `sleepagent/product_device/radar_agent.py`
- `sleepagent/radar_agent/api/http.py`
- `sleepagent/radar_agent/agents/trend.py`
- `sleepagent/radar_agent/product_agent/__init__.py`
- `sleepagent/radar_agent/product_agent/cold_start.py`
- `sleepagent/radar_agent/product_agent/contracts.py`
- `sleepagent/radar_agent/product_agent/governance.py`
- `sleepagent/radar_agent/product_agent/habit_profile.py`
- `sleepagent/radar_agent/product_agent/registry.py`
- `sleepagent/radar_agent/product_agent/runner.py`
- `sleepagent/radar_agent/product_agent/skills.py`
