# Historical v20 acceptance templates — do not collect

This package is identity-stale and retained only for audit regression. Do not
add new evidence here or relabel it for a newer release. Use
`docs/product/habit-profile/real-evidence-v23-collection`.

These files are collection slots, not release evidence. They are bound to:

- release identity: `c620d7050539bc21bd01e357b24265b59d59b116c068b35e8d6e6ebcd7f5dfc4`
